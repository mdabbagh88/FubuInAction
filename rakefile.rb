...
RESULTS_DIR = "results"
PRODUCT = "FubuInAction"
COPYRIGHT = 'Copyright 2012 FubuInAction. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuInAction.sln', :clrversion => CLR_TOOLS_VERSION
